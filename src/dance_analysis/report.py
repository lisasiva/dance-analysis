...
def _compare_table(me: dict, ref: dict) -> list[str]:
    ...
    rows = [
        ...
        ("texture variety (light & shade)", f"{me.get('texture_variety', 0):.2f}",
         f"{ref.get('texture_variety', 0):.2f}",
         _verdict(me.get("texture_variety", 0), ref.get("texture_variety", 0))),
...
_KEY_METRICS = [
    ...
    ("texture variety (light & shade)", lambda m: m.get("texture_variety", 0)),
